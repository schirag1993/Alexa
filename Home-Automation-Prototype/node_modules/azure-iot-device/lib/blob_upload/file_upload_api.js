...
var FileUploadApi = (function () {
    ...
    FileUploadApi.prototype.getBlobSharedAccessSignature = function (blobName, auth, done) {
        ...
        var path = azure_iot_common_1.endpoint.devicePath(this.deviceId) + '/files' + azure_iot_common_1.endpoint.versionQueryString();
        ...
        var req = this.http.buildRequest('POST', path, headers, this.hostname, x509Opts, function (err, body, response) {
            if (err) {
