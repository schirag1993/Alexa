...
import { results, Message, Receiver, TransportConfig } from 'azure-iot-common';
...
export declare class Client extends EventEmitter {
    ...
    private _receiver;
    private _messageReceiverConnected;
    ...
    private _disconnectMessageReceiver();
    private _destroyReceiver();
